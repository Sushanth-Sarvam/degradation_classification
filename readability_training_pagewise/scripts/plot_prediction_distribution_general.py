...
def load_features_and_labels():
    """Load the original features and labels"""
    # Find the most recent EfficientNet embeddings
    ...
    if not embedding_dirs:
        raise FileNotFoundError("No EfficientNet embeddings found")
...
def create_prediction_plots(experiment_dir):
    ...
    train_features, test_features, train_labels, test_labels = load_features_and_labels()

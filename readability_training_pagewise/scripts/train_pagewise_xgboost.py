...
class PagewiseXGBoostTrainer:
    ...
    def train_xgboost(self, X_train, X_test, y_train, y_test):
        ...
        # Parameter grid for page-wise classification (16 combinations: 2×2×2×2×1×1×1)
        param_grid = {
        ...
        self.logger.info(f"🔧 MEDIUM hyperparameter tuning for PAGE-WISE classification...")
    ...
    def _evaluate_model(self, model, X, y, dataset_name):
        ...
        y_prob = model.predict_proba(X)[:, 0]  # Probability of non-readable (class 0)
        ...
        # ROC AUC (for non-readable as positive class)
        try:
            fpr, tpr, _ = roc_curve(y, y_prob, pos_label=0)
...
def main():
    ...
    parser.add_argument('--backbone', type=str, required=True, choices=['efficientnet', 'resnet50', 'yolov8n', 'layoutxlm'], help='Backbone model to use')
